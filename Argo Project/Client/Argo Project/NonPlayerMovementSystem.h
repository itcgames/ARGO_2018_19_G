...
public:
	...
	void update()
	{
		...
		{
			m_entities[i]->getComponent<PositionComponent>(1)->setPosition(Vector2(m_entities[i]->getComponent<PositionComponent>(1)->getPosition().x - m_speed, m_entities[i]->getComponent<PositionComponent>(1)->getPosition().y));
